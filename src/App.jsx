                            ...
                            <div className="rec-panel">
                              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1rem' }}>
                                ...
                                <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '0.75rem' }}>
                                  <div style={{ display: 'flex', gap: '0.25rem', fontWeight: 'bold', fontSize: '2rem' }}>
                                    {[...Array(recommendations.starCount)].map((_, i) => (
                                      <span key={`full-${i}`} style={{ color: '#4169E1' }}>★</span>
                                    ))}
                                    {[...Array(5 - recommendations.starCount)].map((_, i) => (
                                      <span key={`empty-${i}`} style={{ color: '#CCCCCC' }}>★</span>
                                    ))}
                                  </div>
                                  <div style={{ color: '#fef5e7', fontSize: '1rem', fontWeight: '600', textAlign: 'right' }}>
